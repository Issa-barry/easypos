...
"# easypos" 
"# easypos"  git init git add README.md git commit -m "first commit" git branch -M main git remote add origin git@github.com:Issa-barry/easypos.git git push -u origin main
"# easypos" 
"# easypos" 
